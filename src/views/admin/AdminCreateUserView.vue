<template>
  <div class="space-y-6 max-w-2xl mx-auto">
    ...
    <!-- 表單卡片 -->
    <div class="bg-white dark:bg-surface-dark-muted rounded-xl shadow-sm border border-surface-border dark:border-surface-dark-border overflow-hidden">
      <form @submit.prevent="handleSubmit" class="p-6 md:p-8 space-y-6">
        ...
        <!-- 說明提示 -->
        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 rounded-lg text-sm border border-blue-100 dark:border-blue-800/30 flex gap-3">
          <Info class="w-5 h-5 shrink-0 mt-0.5" />
          <div>
            <p class="font-medium mb-1">注意：需要部署 Edge Function</p>
            <p>此功能會呼叫名稱為 <code>create-user</code> 的 Supabase Edge Function。請確保您已使用 Supabase CLI 將其部署至您的專案中。</p>
          </div>
        </div>
