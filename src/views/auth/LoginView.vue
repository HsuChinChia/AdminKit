    ...
    <Transition name="fade-up" appear>
      <div class="relative w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary-600 shadow-lg shadow-primary-600/40 mb-4">
        ...
        <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <Transition name="fade">
            <div v-if="errorMsg" class="flex items-center gap-2 bg-red-500/20 border border-red-500/30 text-red-200 rounded-lg px-4 py-3 mb-5 text-sm">
          ...
          <form @submit.prevent="handleLogin" class="space-y-5">
            ...
            <div>
              <div class="flex items-center justify-between mb-1.5">
                ...
                <RouterLink to="/forgot-password" class="text-xs text-primary-400 hover:text-primary-300 transition">忘記密碼？</RouterLink>
              </div>
              <div class="relative">
          ...
          <p class="text-center text-sm text-slate-400 mt-6">
            還沒有帳號？
            <RouterLink to="/register" class="text-primary-400 hover:text-primary-300 font-medium transition">立即註冊</RouterLink>
          </p>
        </div>
      </div>
    </Transition>
